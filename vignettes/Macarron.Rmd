...
```{r dataframes-as-inputs, eval=FALSE}
...
```{r running-individual-functions, eval = FALSE}
...
```{r change-prevalence, eval=FALSE}
prism_prioritized <- Macarron::Macarron(input_abundances = abundances_df,
                                        input_annotations = annotations_df,
                                        input_metadata = metadata_df,
                                        input_taxonomy = taxonomy_df,
...
```{r change-min-module-size, eval=FALSE}
...
```{r specify-covariates, eval=FALSE}
prism_qval <- calQval(se = prism_mbx,
                      mod.assn = prism_modules,
